...
# 일반적인 프로그래밍 언어와 다르게 길이를 동적으로 조절할 수 있어 리스트라고 부른다.
...
# 같은 값이 리스트 내에 여러 개 존재하면 가자 처음에 존재하는 값의 인덱스를 반환한다.
print("index : ", fruits.index('apple'))

print("index : ", fruits.index('apple',3))


# 3. reverse() : list 값을 역으로 정렬한다. 값은 list에 영향을 준다.
fruits.reverse()
print(fruits)


# 4. append() : list 끝에 값을 덫붙여 추가한다.
